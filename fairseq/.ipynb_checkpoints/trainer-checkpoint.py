...
class Trainer(object):
    ...
    def __init__(self, args, task, model, criterion, dummy_batch=None, oom_batch=None, quantizer=None):
        self.args = args
        self.task = task
    ...
    def save_checkpoint(self, filename, extra_state):
        ...
        if distributed_utils.is_master(self.args):  # only save one checkpoint
            ...
            tmodel = self.get_model()
            s_dict = tmodel.state_dict()
            checkpoint_utils.save_state(
                filename, self.args, s_dict, self.get_criterion(),
