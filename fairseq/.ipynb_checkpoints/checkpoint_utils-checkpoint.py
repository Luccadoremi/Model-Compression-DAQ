...
def load_checkpoint_to_cpu(path, arg_overrides=None, quantized=False):
...
def load_model_ensemble_quantized(filenames, arg_overrides=None, task=None, args=None):
    """Loads an ensemble of quantized models.
    ...
    Args:
        ...
        task (fairseq.tasks.FairseqTask, optional): task to use for loading
    """
    ensemble, args, _task = load_model_ensemble_and_task_quantized(filenames, arg_overrides, task, args)
    return ensemble, args

def load_model_ensemble_and_task_quantized(filenames, arg_overrides=None, task=None, args=None):
    ...
    for filename in filenames:
        ...
        state = load_checkpoint_to_cpu(filename, arg_overrides, quantized=True)
        args = state['args']
        if task is None:
