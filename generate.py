...
def main(args):
    ...
    if args.quantization_config_path:
        ...
        models, _model_args = checkpoint_utils.load_model_ensemble_quantized(
            args.path.split(':'),
...
def cli_main():
    ...
    parser.add_argument('--quantization_config_path', required=True, type=str, help='Quantization config file')
